...
** link:#TreeTaggerInstallationforLinux[TreeTagger Installation for Linux]
** link:#TreeTaggerInstallationforWindows7[TreeTagger Installation for Windows 7]
** link:#TreeTaggerInstallationforOSX[TreeTagger Installation for OS X]
...
[[TreeTaggerInstallationforLinux]]
...
[[TreeTaggerInstallationforWindows7]]
...
** Copy the tree-tagger-windows-3.2/bin/tree-tagger.exe to your folder with the treetagger.jy script 
* From the parameter file section, download the correct model. For the example below download English parameter file (english-par-linux-3.2-utf8.bin.gz)
...
[[TreeTaggerInstallationforOSX]]
TreeTagger Installation for OS X
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

* Go to the link:http://www.cis.uni-muenchen.de/~schmid/tools/TreeTagger/[TreeTagger website]
* Download the tree-tagger-MacOSX-3.2-intel.tar file
** Extract the archive
** Copy the tree-tagger-MacOSX-3.2.intel/bin/tree-tagger file to your folder with the treetagger.jy script
* From the parameter file section, download the correct model. For the example below download English parameter file (english-par-linux-3.2-utf8.bin.gz)
** OS X should unzip the .gz-file automatically, otherwise double-click its icon
** Copy the file english-par-linux-3.2-utf8.bin into the same folder as the treetagger.jy script. Ensure that the name for the model is english-par-linux-3.2-utf8.bin
