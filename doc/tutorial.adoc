...
** link:#ConfigurationFile[ConfigurationFile]
...
once. Download and install the latest Java SE Development Kit (requires
at least Java 1.8) from
the link:http://www.oracle.com/technetwork/java/javase/downloads/jdk8-downloads-2133151.html[Oracle
...
can link:https://github.com/DARIAH-DE/DARIAH-DKPro-Wrapper[download the
latest
binary]. Select
...
----
java -Xmx4g -jar nameOfThePipeline.jar -input pathForTextfile.txt -output pathForOutputfolder
----
...
----
java -Xmx4g -jar wrapper-0.4.0.jar -input C:\goethe.txt -output D:\DKPro\Workspace
----
...
----
java -Xmx4g -jar wrapper-0.4.0.jar -input .\goethe.txt -output .
----
...
command line with the "-help" option.

----
java -Xmx4g -jar wrapper-0.4.0.jar -help
----
...
In order for the pipeline to function correctly, the language of the
target text needs to be specified using the "-language" switch.
Currently, the pipeline ships with default configurations for German,
English, French, and Spanish. An example command would look like this:


----
java-Xmx4g -jar wrapper-0.4.0.jar -language de -input C:\goethe.txt -output .
----
...
----
java-Xmx4g -jar wrapper-0.4.0.jar -language de -input "C:\Romane\*" -output .
----
...
----
java -Xmx4g -jar wrapper-0.4.0.jar -language de -input "/home/xy/Romane/*" -output .
----
...
----
java -Xms4g -jar wrapper-0.4.0.jar -input goethe.txt -output D:\DKPro\Workspace
----
...
The pipeline allows users to select components specifically suited to
their demands by means of a configuration file, as described in the
official link:https://rawgit.com/DARIAH-DE/DARIAH-DKPro-Wrapper/master/doc/user-guide.html#_write_your_own_config_files[installation
and user guide]. In addition to the language specific configuration
files, it also includes a
link:https://rawgit.com/DARIAH-DE/DARIAH-DKPro-Wrapper/master/doc/user-guide.html#_run_a_light_version[light
version] which omits the computationally expensive components.
